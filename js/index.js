...
function logMouseOver(){
  Title.innerHTML = 'TIK TOK IS AWESOME';
  Title.style.color= 'black';
...
featureContent.style.color='black';
...
bottom2[0].style.color= 'black';
bottom2[2].style.color= 'black';
bottom2[1].style.color= 'black';
